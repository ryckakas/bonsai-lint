...
pub const CALM_JAVA: &str = "package p;\n\nclass Calm {\n    int calm() { return 1; }\n}\n";

pub const BUSY_JAVA: &str = "package p;\n\nclass Busy {\n    @Override\n    public int busy(boolean a, boolean b) {\n        if (a) { if (b) { return 1; } }\n        return 0;\n    }\n}\n";

pub const JAVA_GENERATED_HEADER: &str =
    "// Generated by the protocol buffer compiler.  DO NOT EDIT!\n// source: orders.proto\n\n";

pub const CALM_PYTHON: &str = "def calm():\n    return 1\n";

pub const BUSY_PYTHON: &str = "class Busy:\n    @staticmethod\n    def busy(a, b):\n        if a:\n            if b:\n                return 1\n        return 0\n";

pub const PYTHON_GENERATED_HEADER: &str =
    "# -*- coding: utf-8 -*-\n# Generated by the protocol buffer compiler.  DO NOT EDIT!\n# source: orders.proto\n\n";
...
/// Two overloads of one method, each nested to its own depth, so each lands its own score
/// under its own key.
pub fn java_overloads(single: usize, pair: usize) -> String {
    let mut source = String::from("package p;\n\nclass Orders {\n");
    source.push_str(&nest("int process(boolean a) {\n", "a", single));
    source.push_str(&nest("int process(boolean a, boolean b) {\n", "b", pair));
    source.push_str("}\n");
    source
}

/// A property's getter and setter, each nested to its own depth, so each lands its own score
/// under its own key.
pub fn python_accessors(getter: usize, setter: usize) -> String {
    let mut source = String::from("class Cart:\n    @property\n");
    source.push_str(&nest_python("    def total(self):\n", getter));
    source.push_str("\n    @total.setter\n");
    source.push_str(&nest_python("    def total(self, value):\n", setter));
    source
}

fn nest_python(header: &str, depth: usize) -> String {
    let mut source = header.to_string();
    for level in 0..depth {
        writeln!(source, "{}if a:", "    ".repeat(level + 2)).expect("string write");
    }
    writeln!(source, "{}return 1", "    ".repeat(depth + 2)).expect("string write");
    source
}
