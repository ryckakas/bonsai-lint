...
(0, node_test_1.test)("an existing configured path wins", async () => {
    const directory = (0, node_fs_1.mkdtempSync)((0, node_path_1.join)((0, node_os_1.tmpdir)(), "bonsai-binary-"));
    const file = (0, node_path_1.join)(directory, "bonsai");
...
(0, node_test_1.test)("a configured path that does not exist falls through", async () => {
    const binary = await (0, binary_1.resolveBinary)("/nowhere/bonsai");
